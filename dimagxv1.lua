...
local infinitezoom = MainPage.AddButton("Infinite Zoom", function()
...
local ESPButton1 = AimlockPage.AddToggle("Box ESP", false, function(t)
    if t == true then
...
local ESPButton2 = AimlockPage.AddToggle("Name ESP", false, function(t)
    if t == true then
...
local ESPButton3 = AimlockPage.AddToggle("Line ESP", false, function(t)
    if t == true then
...
local invisible = FunstuffPage.AddButton("Invisible", function()
