...
_G.CircleSides = 3604
_G.CircleColor = Color3.fromRGB(0, 166, 88)
...
circle.Color = Color3.fromRGB(0, 166, 88)
...
local lib = library:Load({name = "Yun", sizeX = 378, sizeY = 498, color = Color3.fromRGB(0, 166, 88)})
...
local Nomiam =
    sec:ColorPicker {
    Name = "Library Color",
    Default = Color3.fromRGB(0, 166, 88),
    Flag = "Namzzzz",
    callback = function(e)
        library:SetColor(e)
    end
